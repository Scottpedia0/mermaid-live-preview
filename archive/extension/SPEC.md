...
3. extension opens a new editor/webview panel
4. left side: Mermaid source from the current markdown block
5. right side: live rendered diagram
6. save/apply writes directly back to the original markdown file
...
This project currently exists as a governed spec only.

No dedicated OpenWork/OpenCode project MD is required yet.
If the build starts, this spec becomes the seed for that project.
